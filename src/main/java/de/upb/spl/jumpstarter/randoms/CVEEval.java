...
public class CVEEval {
    ...
    public void eval() {
        ...
        VideoEncoderPreferences.SizeThreshold size = new VideoEncoderPreferences.SizeThreshold(base, 0.008);
        base = new VideoEncoderPreferences.RuntimeThreshold(size, 1);
