...
public class GuoAlgorithm extends AbstractEvolutionaryAlgorithm {
	 ...
	 */
	public GuoAlgorithm(Problem problem, Initialization initialization) {
	...
	protected void iterate() {
		...
		GuoProblemDefinition problem = (GuoProblemDefinition) getProblem();
		if(populationsize < 2) {
	...
	private BenchmarkEnvironment env() {
		return ((GuoProblemDefinition) getProblem()).env();
	}
}
