...
public class FesTransformTest {
	...
	public static void load() throws FeatureModelException {
		String featureModelFile = FesTransformTest.class.getClassLoader().getResource("video_encoder.xml").getPath();
	...
	public void testFesTransform() {
		...
		FesTransform transformation = new FesTransform(featureModel, selection);
	...
	public void testAll() {
		...
		final Function<String, FeatureSelection> selectioner = binaryString -> FMUtil.selectFromPredicate(FMUtil.optFeatureStream(featureModel).collect(Collectors.toList()),
...
//			System.out.println("Selection: " + selection);
			...
			System.out.println(transformation + " is " + (validSelection? "a" : "NOT a") + " valid selection!\n\n");
			if(validSelection) {
